...
;; Clangd LSP
(after! lsp-clangd
  (setq lsp-clangd-binary-path "/usr/local/bin/clangd15")
...
(setq flycheck-python-pycompile-executable "/usr/local/bin/python3.9")
(setq python-shell-exec-path "/usr/local/bin/python3.9")
